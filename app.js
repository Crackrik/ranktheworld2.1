...
class RankEverything {
    constructor() {
        ...
        this.progress = 0;
        this.totalComparisons = null; // Unlimited comparisons
    ...
    updateProgress() {
        // Show progress for current session
        const sessionComparisons = this.progress;
        document.getElementById('progress-text').textContent = `${sessionComparisons} COMPARISONS THIS SESSION`;
        ...
        // Animate progress bar (repeating every 20 comparisons)
        const percent = ((sessionComparisons % 20) / 20) * 100;
